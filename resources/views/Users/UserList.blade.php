...
<body>
        ...
        <div class="flapt-page-content">
            ...
            <div class="left-side-content-area d-flex align-items-center">
              ...
              <div class="mobile-logo">
                <a href="index.php"><img src="img/core-img/small-logo.png" alt="Mobile Logo" /></a>
              </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="row g-4" id="userList">
                                @foreach ($users as $user)
                                    <div class="col-sm-6 col-xl-3 user-card" data-phone="{{ $user->phone_number }}">
                                                    ...
                                                    <div class="single-conatct--area text-center">
                                                        <div class="single-contact-area">
                                                            <div>
                                                                @if ($user->avatar)
                                                                    <img src="{{ asset('storage/' . $user->avatar) }}"
                                                                        alt="user" class="border-radius-50 mb-3"
                                                            ...
                                                            <div class="contact-address mt-15">
                                                                <p class="mb-2 font-15"><strong>Phone:</strong>
                                                                    {{ $user->phone_number }}</p>
                                                                <p class="mb-2 font-15"><strong>Status:</strong>
                                                                    <span
                                                                        class="badge {{ $user->verification_status == 'Verified' ? 'bg-success' : 'bg-warning' }}">
                                ...
                                @endforeach
                                  ...
                                  <div id="noUserMessage" class="text-center w-100" style="display: none;">
        <p class="text-danger fw-bold">User with this phone number not found.</p>
    </div>
                            </div>
  ...
  <script>
    document.getElementById('searchPhone').addEventListener('input', function () {
        ...
        document.getElementById('noUserMessage').style.display = matchFound ? 'none' : 'block';
    });
</script>
