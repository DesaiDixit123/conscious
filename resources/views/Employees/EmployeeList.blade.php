                                            ...
                                            @foreach ($employees as $employee)
                                                <tr>
                                                    ...
                                                    <td class="order-btn d-flex">
                                                        <a href="javascript:void(0);" class="view" title="View"><i
                                                                class="fas fa-eye"></i></a>
                                                        <a href="javascript:void(0);" class="edit" title="Edit"><i
                                                                class="fas fa-edit"></i></a>
                                                        <form action="{{ route('add-employee.destroy', $employee->id) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('Are you sure you want to delete this employee?')">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="text-red-500 hover:text-red-700 bg-transparent border-none"
                                                                title="Delete">
